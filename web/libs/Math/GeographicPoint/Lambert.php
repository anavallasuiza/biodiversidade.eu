...
class Lambert extends GeographicPoint
{
     ...
     * @return void
     */
    public function __construct($easting, $northing, Lambert\Config $config, $datum = '')
    {
    ...
    public function toLatitudeLongitude()
    {
        ...
        return new LatitudeLongitude($this->lat, $this->long);
    }
}
