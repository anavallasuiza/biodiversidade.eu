...
iniciativa.editar = (function () {
    ...
    self.init = function () {
        ...
        // Create the map
		self.mapa = common.map.init('iniciativa', document.querySelector(self.elements.map), config.iniciativa);
        ...
        self.drawingTool = new mapas.DrawingTool(self.mapa, {
            defaultColor: config.iniciativa.COLOR_SHAPE,
            defaultMarker: config.iniciativa.ICON_MARKER,
            selectedMarker: config.iniciativa.ICON_MARKER_SELECTED,
