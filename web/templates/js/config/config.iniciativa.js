...
/**
 * Modulo de configuracion de iniciativa
 */
config.iniciativa = {
    ...
    ICON_MARKER: '<?php echo fileWeb("templates|img/ico-iniciativa10.png", false, true); ?>',
    ICON_MARKER_SELECTED: '<?php echo fileWeb("templates|img/ico-iniciativa18.png", false, true); ?>'
};