...
config.playground = {
    ...
    ICON_AMEAZA_1: '<?php echo fileWeb("templates|img/ico-ameaza1.png", false, true); ?>',
    ICON_AMEAZA_2: '<?php echo fileWeb("templates|img/ico-ameaza2.png", false, true); ?>',
    ICON_AMEAZA: '<?php echo fileWeb("templates|img/ico-ameaza13.png", false, true); ?>',
    ICON_AMEAZA_SELECTED: '<?php echo fileWeb("templates|img/ico-ameaza18.png", false, true); ?>'
};