...
Loader::register(SCENE_PATH.$Config->scene_paths['libs']);

define('WEB_PATH', BASE_PATH.$Vars->getSceneConfig('folder', '', 'web'));

$Config->load(array('actions.php', 'routes.php'));
$Config->load(array('db.php', 'tables.php', 'languages.php', 'events.php', 'session.php'), WEB_PATH.'config/');
